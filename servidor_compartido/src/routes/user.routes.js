...
const { postUser, postLogin, getUsers, getUserId,activeUser, inactiveUser, denyUser, changePassword, solicitarRestablecimiento, restablecerContraseña, logout, editUsered} = require('../controller/user.controller');
